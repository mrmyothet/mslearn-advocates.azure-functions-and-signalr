...
#
# create-resources-concierge-subscription "RESOURCE_GROUP_NAME"
# create-start-resources.sh "learn-11b5fbe9-d263-47bc-9552-7d3dd2153f92"
#


set -e

printf "Resource Group Name: $1\n"
...
# I do not have permissions to create resource groups under Concierge Subscription
